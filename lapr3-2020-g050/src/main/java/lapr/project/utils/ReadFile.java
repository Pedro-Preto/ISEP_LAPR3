...
public class ReadFile {
    ...
    public LinkedList<GeoLocation> geoLocations = new LinkedList<>();
    ...
    public boolean readGeoLocationFile() {
        try {
            ...
            while (sc.hasNextLine()) {
                ...
                geoLocations.add(new GeoLocation(Integer.parseInt(lineContent[0]), Double.parseDouble(lineContent[1]),
                        Double.parseDouble(lineContent[2]), Integer.parseInt(lineContent[3]), Integer.parseInt(lineContent[4])));
    ...
    public boolean readAddressFile() {
        try {
            ...
            while (sc.hasNextLine()) {
                ...
                addresses.add(new Address(Integer.parseInt(lineContent[0]), lineContent[1], lineContent[2], lineContent[3], lineContent[4]));
